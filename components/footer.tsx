  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div className="xl:grid xl:grid-cols-3 xl:gap-24">
        ...
        <div>
          <h3 className="text-sm font-semibold leading-6 text-emerald-100">Quick Links</h3>
          <ul role="list" className="mt-6 space-y-4">
            {[
              ...
              <li key={item.name}>
                <Link href={item.href} className="text-sm leading-6 text-emerald-100/70 hover:text-emerald-100">
                  {item.name}
                </Link>
              </li>
            ))}
        ...
        <div>
          <h3 className="text-sm font-semibold leading-6 text-emerald-100">Contact Information</h3>
          <ul role="list" className="mt-6 space-y-4">
            <li className="flex gap-2">
              <Mail className="h-5 w-5 text-emerald-400" />
              <Link href="mailto:info@arbicho.com" className="text-sm leading-6 text-emerald-100/70 hover:text-emerald-100">
                info@arbicho.com
              </Link>
            </li>
            <li className="flex gap-2">
              <Phone className="h-5 w-5 text-emerald-400" />
              <span className="text-sm leading-6 text-emerald-100/70">+998-XX-XXX-XXXX</span>
            </li>
            <li className="flex gap-2">
              <MapPin className="h-5 w-5 text-emerald-400" />
              <span className="text-sm leading-6 text-emerald-100/70">Tashkent, Uzbekistan</span>
            </li>
          </ul>
        </div>
